...
PaperlessNgxMCPSharp is licensed under the MIT License (see `LICENSE`). It
...
"Paperless-ngx" and "paperless-ng" are community project names. This project is
an independent MCP wrapper and is not affiliated with the Paperless-ngx
maintainers.
